...
public struct Theme {
    ...
    public var code: AnyTextStyle = AnyTextStyle(erasing: FontFamilyVariant(.monospaced))
    
    /// The emphasis style.
    public var emphasis: AnyTextStyle = AnyTextStyle(erasing: FontStyle(.italic))
    
    /// The strong style.
    public var strong: AnyTextStyle = AnyTextStyle(erasing: FontWeight(.semibold))
    
    /// The strikethrough style.
    public var strikethrough: AnyTextStyle = AnyTextStyle(erasing: StrikethroughStyle(.single))
    
    /// The link style.
    public var link: AnyTextStyle = AnyTextStyle(erasing: EmptyTextStyle())
...
extension Theme {
    ...
    public func text<S: TextStyle>(@TextStyleBuilder text: () -> S) -> Theme {
        var theme = self
        theme.text = AnyTextStyle(erasing: text())
        return theme
    }
    ...
    public func code<S: TextStyle>(@TextStyleBuilder code: () -> S) -> Theme {
        var theme = self
        theme.code = AnyTextStyle(erasing: code())
        return theme
    }
    ...
    public func emphasis<S: TextStyle>(@TextStyleBuilder emphasis: () -> S) -> Theme {
        var theme = self
        theme.emphasis = AnyTextStyle(erasing: emphasis())
        return theme
    }
    ...
    public func strong<S: TextStyle>(@TextStyleBuilder strong: () -> S) -> Theme {
        var theme = self
        theme.strong = AnyTextStyle(erasing: strong())
        return theme
    }
    ...
    public func strikethrough<S: TextStyle>(@TextStyleBuilder strikethrough: () -> S) -> Theme {
        var theme = self
        theme.strikethrough = AnyTextStyle(erasing: strikethrough())
        return theme
    }
    ...
    public func link<S: TextStyle>(@TextStyleBuilder link: () -> S) -> Theme {
        var theme = self
        theme.link = AnyTextStyle(erasing: link())
        return theme
    }
}
