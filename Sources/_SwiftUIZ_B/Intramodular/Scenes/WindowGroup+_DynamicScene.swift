...
#if os(macOS)
extension Window: _SwiftUIZ_A._DynamicScene where Content: _InterposedSceneContent {
...
extension WindowGroup: _SwiftUIZ_A._DynamicScene where Content: _InterposedSceneContent {
    public enum _DynamicWindowGroupKeyword {
        case dynamic
    }
