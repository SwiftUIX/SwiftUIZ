...
public enum _DynamicSceneInitializers {
    ...
    >: _DynamicSceneInitializer {
        ...
        package init(value: @escaping (Value) -> Content?) {
            self.value = value
        }
    ...
    >: _DynamicSceneInitializer {
        ...
        package init(
            ...
            content: @escaping (_FileDocumentConfiguration<Document>) -> Content
        ) {
    ...
    >: _DynamicSceneInitializer {
        ...
        package init(
            newDocument: @escaping () -> Document,
            content: @escaping (_ReferenceFileDocumentConfiguration<Document>) -> Content
        ) {
            self.newDocument = newDocument
            self.content = content
        }
