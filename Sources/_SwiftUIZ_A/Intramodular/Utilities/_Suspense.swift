...
/// ```
///
public struct _Suspense<Value, Failure: Error, Content: View, Suspending: View, FailureContent: View>: View {
...
private extension _Suspense {
    @MainActor
    final class InternalState: ObservableObject {
        @Published
        private(set) var phase = _AsyncPhase<Value, Failure>.suspending
