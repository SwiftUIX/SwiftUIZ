...
/// A value that represents a success, a failure, or a state in which the result of asynchronous process has not yet been determined.
public enum _AsyncPhase<Success, Failure: Error> {
    ...
    public func map<NewSuccess>(_ transform: (Success) -> NewSuccess) -> _AsyncPhase<NewSuccess, Failure> {
    ...
    public func mapError<NewFailure>(_ transform: (Failure) -> NewFailure) -> _AsyncPhase<Success, NewFailure> {
    ...
    public func flatMap<NewSuccess>(_ transform: (Success) -> _AsyncPhase<NewSuccess, Failure>) -> _AsyncPhase<NewSuccess, Failure> {
        switch self {
            case .suspending:
                return .suspending
    ...
    public func flatMapError<NewFailure>(_ transform: (Failure) -> _AsyncPhase<Success, NewFailure>) -> _AsyncPhase<Success, NewFailure> {
        switch self {
            case .suspending:
                return .suspending
...
extension _AsyncPhase: Sendable where Success: Sendable {
    
}

extension _AsyncPhase: Equatable where Success: Equatable, Failure: Equatable {
    
}

extension _AsyncPhase: Hashable where Success: Hashable, Failure: Hashable {
